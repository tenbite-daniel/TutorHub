...
export default function TutorProfilePage() {
  ...
  const handleArrayInput = (field: 'subjects' | 'grades' | 'availability', value: string) => {
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-900">${profile.hourlyRate || 'Not set'}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-gray-900">{profile.subjects.join(', ')}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700">Grades</label>
                    <p className="mt-1 text-gray-900">{profile.grades.join(', ')}</p>
                  </div>
                  <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleArrayInput('grades', e.target.value)}
